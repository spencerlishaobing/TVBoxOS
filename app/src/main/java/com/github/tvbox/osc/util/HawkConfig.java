...
public class HawkConfig {
    ...
    public static final String LIVE_SOURCE_URL_HISTORY = "live_source_url_history";
    public static final String LIVE_SOURCE_URL_CURRENT = "live_source_url_current";
    ...
    public static final String LIVE_CHANNEL_SOURCE_CACHE = "live_channel_source_cache";
